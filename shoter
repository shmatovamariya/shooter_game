...
#фоновая музыка
mixer.init()
mixer.music.load('megusta.ogg')
mixer.music.play()
fire_sound = mixer.Sound('nope.ogg')

#нам нужны такие картинки:
img_back = "6nQvOqT3qok.jpg" #фон игры
img_bullet = "p3btEpSF1l4.jpg" #пуля
img_hero = "vkDubHuzsCY.jpg" #герой
img_enemy = "vO6XXxmJNMA.jpg" #враг
